...
上周突然来了兴致，想好好经营一下小红书账号。一方面是前些天~~没忍住~~下单了大疆 Pocket 4，想着要不先把号热一热？等后面再拍些 vlog 分享。另一方面是一直有想做一些个人 IP 相关的东西。
...
当前采用的方案是基于开源的 [Memos](https://usememos.com/)，通过 Docker 部署在家里的 NAS 上，再配合 Cloudflared 打通公网，方便随时随地记录和检索。当然还有一些就直接复制粘贴进 flomo 里。相比而言，Logseq 记的是越来越少，目前还是更看重能上云和浏览器访问。
