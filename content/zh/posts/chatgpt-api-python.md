...
![](https://kohsruhe-images.oss-cn-shanghai.aliyuncs.com/images/trial-usage.jpg)
...
如果是系统有安装多个 Python 版本，可参考[之前文章](https://www.kohsruhe.com/zh/2022/12/30/manage-multi-pythons/)使用 `py.exe` 指定 pip 版本安装：
...
![](https://kohsruhe-images.oss-cn-shanghai.aliyuncs.com/images/chatgpt-demo-output.png)
